/**
 * Heron Wellnest Badge Worker API
 *
 * @file app.ts
 * @description Sets up and configures the Express application instance for the
 * Heron Wellnest Badge Worker API. This file defines middleware, routes,
...
import badgeWorker from './routes/badgeWorker.route.js'
...
app.get('/api/v1/badge-worker/health', (_req, res) => {
  res.status(200).json({ status: 'ok' });
});
app.use('/api/v1/badge-worker/pubsub', badgeWorker);
